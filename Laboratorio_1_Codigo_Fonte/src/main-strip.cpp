...
const int VERTICES_EXTERNOS = 16;
const float RAIO_DE_FORA = 0.7f;
const float RAIO_DE_DENTRO = 0.5f;
...
GLuint BuildTriangles()
{
    ...
    for(i = 0; i < qtd_vertices_a_desenhar; i += 8){
        NDC_coefficients[i + 0] = RAIO_DE_DENTRO * cos(angulo); //X
        NDC_coefficients[i + 1] = RAIO_DE_DENTRO * sin(angulo); //Y
        NDC_coefficients[i + 4] = RAIO_DE_FORA * cos(angulo); //X
